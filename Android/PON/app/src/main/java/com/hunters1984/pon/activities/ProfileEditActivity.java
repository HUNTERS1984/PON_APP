...
import com.hunters1984.pon.api.ResponseUserProfileData;
...
import com.hunters1984.pon.utils.ImageUtils;
    ...
    private void initLayout()
    {
        ...
        mBtnUpdateProfile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String address = String.valueOf(mSpnPrefecture.getSelectedItemPosition());
