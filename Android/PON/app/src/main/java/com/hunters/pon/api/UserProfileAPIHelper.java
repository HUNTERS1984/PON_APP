...
//            }
    ...
    public void signOut(Context context, final Handler handler)
    {
        if(NetworkUtils.isNetworkAvailable(context)) {
            showProgressDialog(context);
            Retrofit retrofit = new Retrofit.Builder()
            ...
            Call<ResponseCommon> response = service.signOut(token);
    ...
    public void signInShareFacebook(Context context, String fbToken, final Handler handler)
    {
        if(NetworkUtils.isNetworkAvailable(context)) {
            showProgressDialog(context);
            Retrofit retrofit = new Retrofit.Builder()
            ...
            Call<ResponseCommon> response = service.signInShareFacebook(token, fbToken);
    ...
    public void signInShareTwitter(Context context, String accessToken, String secretToken, final Handler handler)
    {
        if(NetworkUtils.isNetworkAvailable(context)) {
            showProgressDialog(context);
            Retrofit retrofit = new Retrofit.Builder()
            ...
            Call<ResponseCommon> response = service.signInShareTwitter(token, accessToken, secretToken);
    ...
    public void signInShareInstagram(Context context, String instagramToken, final Handler handler)
    {
        if(NetworkUtils.isNetworkAvailable(context)) {
            showProgressDialog(context);
            Retrofit retrofit = new Retrofit.Builder()
            ...
            Call<ResponseCommon> response = service.signInShareInstagram(token, instagramToken);
    ...
    public void signInShareLine(Context context, String lineToken, final Handler handler)
    {
        if(NetworkUtils.isNetworkAvailable(context)) {
            showProgressDialog(context);
            Retrofit retrofit = new Retrofit.Builder()
            ...
            Call<ResponseCommon> response = service.signInShareLine(token, lineToken);
    ...
    public void forgotPassword(Context context, String email, final Handler handler)
    {
        if(NetworkUtils.isNetworkAvailable(context)) {
            showProgressDialog(context);
            Retrofit retrofit = new Retrofit.Builder()
            ...
            Call<ResponseCommon> response = service.forgotPassword(email);
