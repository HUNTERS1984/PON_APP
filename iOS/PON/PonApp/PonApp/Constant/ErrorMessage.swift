...
let UnLikeCouponConfirmation                    = "このクーポンを”unlike”にしますか。"//Bạn có chắc bạn muốn unlike coupon này
...
let UnFollowShopConfirmation                    = "この店をアンフォローしますか？"//Bạn có chắc bạn muốn unfollow shop này
