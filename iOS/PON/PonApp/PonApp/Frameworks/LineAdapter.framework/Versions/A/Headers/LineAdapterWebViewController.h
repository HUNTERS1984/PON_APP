...
typedef NS_ENUM(NSUInteger, LineAdapterWebViewOrientation)
{
    LineAdapterWebViewOrientationPortrait,
    LineAdapterWebViewOrientationLandscape,
    LineAdapterWebViewOrientationAll,

    // Deprecated
    kOrientationPortrait DEPRECATED_MSG_ATTRIBUTE("use LineAdapterWebViewOrientationPortrait") NS_SWIFT_UNAVAILABLE("use LineAdapterWebViewOrientation.Portrait")    = LineAdapterWebViewOrientationPortrait,
    kOrientationLandscape DEPRECATED_MSG_ATTRIBUTE("use LineAdapterWebViewOrientationLandscape") NS_SWIFT_UNAVAILABLE("use LineAdapterWebViewOrientation.Landscape") = LineAdapterWebViewOrientationLandscape,
