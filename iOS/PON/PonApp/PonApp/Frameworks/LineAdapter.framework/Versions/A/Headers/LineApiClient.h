...
NS_ENUM(NSInteger)
{
    LineAdapterErrorNone,
    LineAdapterErrorMissingConfiguration,
    LineAdapterErrorAuthorizationAgentNotAvailable,
    LineAdapterErrorInternalInconsistency,
    LineAdapterErrorInvalidServerResponse,
    LineAdapterErrorAuthorizationDenied,
    LineAdapterErrorAuthorizationFailed,
    LineAdapterErrorAuthorizationExpired,
    LineAdapterErrorAccessTokenIsNotAvailable,
    LineAdapterErrorNoLongerRefreshToken,
    LineAdapterErrorUnknownError,
};
...
- (void)getOTPForChanneID:(NSString *)aChannelID
              resultBlock:(LineApiClientResultBlock)aResultBlock;

- (void)getAccessTokenForChannelID:(NSString *)aChannelID
                  withRequestToken:(NSString *)aRequestToken andOTP:(NSString *)aOTP resultBlock:(LineApiClientResultBlock)aResultBlock;
...
NS_ENUM(NSInteger)
{
    ...
    kLineAdapterErrorAuthorizationAgentNotAvailable DEPRECATED_MSG_ATTRIBUTE("use LineAdapterErrorAuthorizationAgentNotAvailable") NS_SWIFT_UNAVAILABLE("use LineAdapterErrorAuthorizationAgentNotAvailable") = LineAdapterErrorAuthorizationAgentNotAvailable,
